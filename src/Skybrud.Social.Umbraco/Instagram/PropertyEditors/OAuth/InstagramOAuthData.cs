...
namespace Skybrud.Social.Umbraco.Instagram.PropertyEditors.OAuth {
    ...
    public class InstagramOAuthData {
        ...
        /// </summary>
        public InstagramService GetService(string facebookApiVersion = PackageHelpers.FacebookApiVersion) {
            return _service ?? (_service = InstagramService.CreateFromAccessToken(AccessToken, facebookApiVersion, UseInstagramGraphAPI != null? UseInstagramGraphAPI.Value : false));
        }
